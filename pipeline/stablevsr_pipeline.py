...
class StableVSRPipeline(
    ...
    def __init__(
        ...
        aesthetic_model: Optional[torch.nn.Module] = None,  ### Add the aesthetic_model for reference step
    ):
        super().__init__()
        ...
        self.aesthetic_model = aesthetic_model ### Add the aesthetic_model for reference step
    ...
    def __call__(
        ...
        ### Apply the aesthetic model to the decoded images
        images = [self.aesthetic_model(image.unsqueeze(0)).squeeze(0) if self.aesthetic_model is not None else image for image in images]
