...
controlnet_model = ControlNetModel.from_pretrained(args.controlnet_ckpt if args.controlnet_ckpt is not None else model_id, subfolder='controlnet') # ControlNetModel.from_pretrained("/home/yuxin/StableVSR/experiments/model7_checkpoint-40000", subfolder='controlnet') # your own controlnet model
